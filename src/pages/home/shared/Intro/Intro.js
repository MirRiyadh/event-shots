    ...
    <div className="w-11/12  lg:w-9/12 m-auto ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="text-center md:text-left mb-4">
          ...
          <p>
            Being a professional photographer means working with people—whether
            it’s a client, a model, or even a fellow photographer. Thus, being a
            good photographer requires good people skills — it’s one of the
            essential photographer qualities. You’ll also need to network to
          ...
          <div className="flex items-center mt-2 text-purple-700 font-semibold justify-center lg:justify-start">
