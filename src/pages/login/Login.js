...
import image from "../../assets/photos/3293465.jpg";
...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:w-8/12 lg:m-auto">
      <div className="p-6 m-auto">
        <img src={image} alt="" />
      </div>
      <div className="relative flex flex-col justify-center md:mt-20 lg:mt-0 lg:min-h-screen overflow-hidden">
